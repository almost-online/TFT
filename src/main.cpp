...
#define WAIT 1200 // Delay between tests, set to 0 to demo speed, 2000 to see what it does!
...
// Clear the screen and draw the frame
  Serial.print("Clear screen and draw colored");
  Serial.println();
...
// Draw sin-, cos- and tan-lines  
  ...
  Serial.print("Clear screen and run test 2");
  Serial.println();
...
int col = 0;
  ...
  Serial.print("Clear screen and run test 3");
  Serial.println();
  tft.fillRect(1,15,478-1,304-15,TFT_BLACK);
...
// Draw some filled rectangles
  ...
  delay(WAIT);
  Serial.print("Clear screen and run test 4");
  Serial.println();
...
// Draw some filled, rounded rectangles
  ...
  delay(WAIT);
  Serial.print("Clear screen and run test 5");
  Serial.println();
...
// Draw some filled circles
  ...
  delay(WAIT);
  Serial.print("Clear screen and run test 6");
  Serial.println();
...
// Draw some lines in a pattern
  ...
  delay(WAIT);
  Serial.print("Clear screen and run test 7");
  Serial.println();
...
// Draw some random circles
  ...
  delay(WAIT);
  Serial.print("Clear screen and run test 8");
  Serial.println();
...
// Draw some random rectangles
  ...
  delay(WAIT);
  Serial.print("Clear screen and run test 9");
  Serial.println();
...
// Draw some random rounded rectangles
  ...
  delay(WAIT);
  Serial.print("Clear screen and run test 10");
  Serial.println();
  ...
  delay(WAIT);
  Serial.print("Clear screen and run test 11");
  Serial.println();
  ...
  delay(WAIT);
  Serial.print("Clear screen and run test 12");
  Serial.println();
